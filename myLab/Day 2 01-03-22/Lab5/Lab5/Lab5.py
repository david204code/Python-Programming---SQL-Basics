...
# a function call map which turn the string into integar
...
print("Mean grade is", round(statistics.mean(grades), 2))
print("Medium grade is", statistics.median(grades))
print()
