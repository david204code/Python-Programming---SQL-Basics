...
agesLength = len(ages)
print('The length of ages is',agesLength)
...
print('The number of ages between 16 and 25 is',count)
print("")
...
print('The proportion of ages between 16 and 25 is',count,':',len(ages))
print('The proportion of ages between 16 and 25 is',count,':',agesLength)
